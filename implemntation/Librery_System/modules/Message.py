...
class myMessage():
        ...
        def __init__(self,form : QMainWindow,ui_form,h = 30) -> None:
                ui_form.button = QPushButton(form)
                ui_form.button.setGeometry(0,form.height(),form.width(),h)
                
                self.form = form
                self.button = ui_form.button
